...
public interface Platform {
   ...
   */
  int wordSize = PlatformUtil.getWordSize();

  /** The CPU Architecture of the host, e.g x86 or arm. */
  ArchFamily archFamily = ArchFamily.get();

  /** The CPU Target of the host, e.g x86_64 or aarch64. */
  String archTarget = archFamily.getArchTarget(wordSize);
  ...
  OSFamily OS_FAMILY = OSFamily.get();
